...
import type { ActiveCardData } from '../../../api/types';
...
export const ActiveCardsChart = ({ props }: { props: IBarChart }) => {
    ...
    useEffect(() => {
        const loadData = async (): Promise<void> => {
            try {
                const obj = await getChartResults(411);

                const activeData = obj.result[0]?.data as ActiveCardData[];
            ...
            areaStyle: {
                color: {
                    ...
                    colorStops: [
                        {
                            offset: 0,
                            color: 'rgba(207, 157, 63, 0.20)',
                        },
                        {
                            offset: 1,
                            color: 'rgba(207, 157, 63, 0.04)',
                        },
                    ],
                },
            },
